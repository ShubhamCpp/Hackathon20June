<?php	
	...
	function getMeetUpDetails($meetupid)
	{
		...
		$meetUpDetailsQuery = 
		"
			SELECT meetups.mid,meetups.mname,meetups.mdescription,meetups.date,meetups.from_time,meetups.from_period,meetups.to_time,meetups.to_period,meetups.landmark,meetups.latitude,meetups.longitude,locations.lid,locations.lname,users.uid,users.uname FROM meetups 
...
<div class="wrapper bgded overlay light" style="background-color:white;">
  <section class="hoc container clear">    
	...
	<input type="hidden" id="lat" name="lat" value="<?php echo $meetUpDetails['latitude']; ?>" />
	<input type="hidden" id="lon" name="lon" value="<?php echo $meetUpDetails['longitude']; ?>" />
